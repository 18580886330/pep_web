define(['app', '../../services/writeReport/writeReportServices','../../controllers/calculate/defaultData','../../content/lib/base/toolFuns','../../content/lib/layer/laydate/laydate.dev'], function(app, writeReportServices, defaultData, toolFuns) {
                ...
                var bindHover = function(elms){
                    elms.each(function(index,elm){
                        $(elm).hover(function(){
                            ...
                            // 枚举类型转换
                            $scope.n0_ChengBenFa_JiZhunDiJiaJiBieCh = numberToCh[$scope.ChengBenFaData.n0_ChengBenFa_JiZhunDiJiaJiBie];
                            $scope.n0_ChengBenFa_PianQuBianHaoRoman = roman[$scope.ChengBenFaData.n0_ChengBenFa_JiZhunDiJiaJiBie];
                            ...
                            $scope.reqDataGrid = function(pageObj){
                                ...
                                _this.getAutomaticPageList(reqData,function(data){
                                    ...
                                    $timeout(function(){
                                         ...
                                         * 调用分页功能
                                         */
                                        resetPageList('paginationConf',casePopObj.itemsPerPage,$scope.dataPaging,function(obj){
                                            // 自定义请求回调
    ...
    var exploration = (function(){
        ...
        return {
            ...
            checkboxOptions:function(){
                $scope.checkboxCick = function(e){
                    var node = e.target;
                    var dataModel = node.getAttribute('data-model');
                    var checkboxArr = eval("$scope."+dataModel+".split('、')");
     ...
     * 基础信息
     */
    /*if($location.path().match('baseInfo')) {
        baseInfo.init();
    }*/
    /**
     * 权益信息
     */
    /*if($location.path().match('interestsInfo')) {
        interestsInfo.init();
    }*/
    ...
    function getMarketReqData() {
        ...
        for (var i = 0; i < entityArr.length; i++) {
            ...
            }else if(entityArr[i].tableName=='n0_GuJiaShiShengMing'){
                entityArr[i].fields = $scope.GuJiaShiShengMingData;
            }else if(entityArr[i].tableName=='n0_GuJiaShiJiaShe'){
                entityArr[i].fields = $scope.GuJiaShiJiaSheData;
            }else if(entityArr[i].tableName=='n0_XianZhiTiaoJian'){
                entityArr[i].fields = $scope.XianZhiTiaoJianData;
            }else if(entityArr[i].tableName=='n0_QiTaShuoMingShiXiang'){
                entityArr[i].fields = $scope.QiTaShuoMingShiXiangData;
            }
        };
        ...
        /*var dataJSON = {
            reportId: 120,
            entitys: [{
                tableName: 'n0_GuJiaDuiXiang',
                fields: {
                    XiangMuMingChen: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_XiangMuMingChen,
                    ZongJia: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ZongJia,
                    DanJia: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_DanJia,
                    JiaoYiRiQi: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoYiRiQi==''?'':$scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoYiRiQi+' 00:00:00',
                    JiaoYiRiQiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoYiRiQiv,
                    ShiChangZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ShiChangZhuangKuang,
                    JiaoYiZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoYiZhuangKuang,
                    ShiChangZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ShiChangZhuangKuangv,
                    JiaoYiZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoYiZhuangKuangv,
                    ChaoXiang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ChaoXiang,
                    ChaoXiangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ChaoXiangv,
                    JiaoTongZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoTongZhuangKuang,
                    JiaoTongZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiaoTongZhuangKuangv,
                    HuanJingZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_HuanJingZhuangKuang,
                    HuanJingZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_HuanJingZhuangKuangv,
                    JiChuSheShiPeiTao: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiChuSheShiPeiTao,
                    JiChuSheShiPeiTaov: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JiChuSheShiPeiTaov,
                    GongGongFuWuSheShi: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_GongGongFuWuSheShi,
                    GongGongFuWuSheShiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_GongGongFuWuSheShiv,
                    JianZhuMianJi: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuMianJi,
                    JianZhuMianJiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuMianJiv,
                    CheWei: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_CheWei,
                    CheWeiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_CheWeiv,
                    WuYeGuanLi: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_WuYeGuanLi,
                    WuYeGuanLiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_WuYeGuanLiv,
                    XiaoQuHuanJing: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_XiaoQuHuanJing,
                    XiaoQuHuanJingv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_XiaoQuHuanJingv,
                    JianZhuLeiBie: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuLeiBie,
                    JianZhuLeiBiev: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuLeiBiev,
                    JianZhuJieGou: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuJieGou,
                    JianZhuJieGouv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianZhuJieGouv,
                    JianChengNianDai: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianChengNianDai,
                    JianChengNianDaiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_JianChengNianDaiv,
                    SheShiSheBei: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_SheShiSheBei,
                    SheShiSheBeiv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_SheShiSheBeiv,
                    HuXing: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_HuXing,
                    HuXingv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_HuXingv,
                    SuoZaiCengZongLouCeng: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_SuoZaiCengZongLouCeng,
                    SuoZaiCengZongLouCengv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_SuoZaiCengZongLouCengv,
                    ZhuangXiuZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ZhuangXiuZhuangKuang,
                    ZhuangXiuZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_ZhuangXiuZhuangKuangv,
                    QiTaYinSu: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_QiTaYinSu,
                    QiTaYinSuv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_QiTaYinSuv,
                    QuanYiZhuangKuang: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_QuanYiZhuangKuang,
                    QuanYiZhuangKuangv: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_QuanYiZhuangKuangv,
                    BiJiaoFaPingGuDanJia: $scope.GuJiaDuiXiangData.n0_GuJiaDuiXiang_BiJiaoFaPingGuDanJia
                }
            }, {
                tableName: 'n0_KeBiShiLi1',
                fields: {
                    XiangMuMingChen: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_XiangMuMingChen,
                    ZongJia: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ZongJia,
                    DanJia: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_DanJia,
                    JiaoYiRiQi: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoYiRiQi==''?'':$scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoYiRiQi+' 00:00:00',
                    JiaoYiRiQiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoYiRiQiv,
                    ShiChangZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ShiChangZhuangKuang,
                    JiaoYiZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoYiZhuangKuang,
                    ShiChangZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ShiChangZhuangKuangv,
                    JiaoYiZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoYiZhuangKuangv,
                    ChaoXiang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ChaoXiang,
                    ChaoXiangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ChaoXiangv,
                    JiaoTongZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoTongZhuangKuang,
                    JiaoTongZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiaoTongZhuangKuangv,
                    HuanJingZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_HuanJingZhuangKuang,
                    HuanJingZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_HuanJingZhuangKuangv,
                    JiChuSheShiPeiTao: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiChuSheShiPeiTao,
                    JiChuSheShiPeiTaov: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JiChuSheShiPeiTaov,
                    GongGongFuWuSheShi: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_GongGongFuWuSheShi,
                    GongGongFuWuSheShiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_GongGongFuWuSheShiv,
                    JianZhuMianJi: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuMianJi,
                    JianZhuMianJiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuMianJiv,
                    CheWei: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_CheWei,
                    CheWeiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_CheWeiv,
                    WuYeGuanLi: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_WuYeGuanLi,
                    WuYeGuanLiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_WuYeGuanLiv,
                    XiaoQuHuanJing: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_XiaoQuHuanJing,
                    XiaoQuHuanJingv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_XiaoQuHuanJingv,
                    JianZhuLeiBie: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuLeiBie,
                    JianZhuLeiBiev: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuLeiBiev,
                    JianZhuJieGou: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuJieGou,
                    JianZhuJieGouv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianZhuJieGouv,
                    JianChengNianDai: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianChengNianDai,
                    JianChengNianDaiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_JianChengNianDaiv,
                    SheShiSheBei: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_SheShiSheBei,
                    SheShiSheBeiv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_SheShiSheBeiv,
                    HuXing: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_HuXing,
                    HuXingv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_HuXingv,
                    SuoZaiCengZongLouCeng: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_SuoZaiCengZongLouCeng,
                    SuoZaiCengZongLouCengv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_SuoZaiCengZongLouCengv,
                    ZhuangXiuZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ZhuangXiuZhuangKuang,
                    ZhuangXiuZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_ZhuangXiuZhuangKuangv,
                    QiTaYinSu: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_QiTaYinSu,
                    QiTaYinSuv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_QiTaYinSuv,
                    QuanYiZhuangKuang: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_QuanYiZhuangKuang,
                    QuanYiZhuangKuangv: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_QuanYiZhuangKuangv,
                    XiuZhengXiShu: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_XiuZhengXiShu,
                    BiZhunJiaZhi: $scope.KeBiShiLi1Data.n0_KeBiShiLi1_BiZhunJiaZhi
                }
            }, {
                tableName: 'n0_KeBiShiLi2',
                fields: {
                    XiangMuMingChen: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_XiangMuMingChen,
                    ZongJia: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ZongJia,
                    DanJia: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_DanJia,
                    JiaoYiRiQi: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoYiRiQi==''?'':$scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoYiRiQi+' 00:00:00',
                    JiaoYiRiQiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoYiRiQiv,
                    ShiChangZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ShiChangZhuangKuang,
                    JiaoYiZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoYiZhuangKuang,
                    ShiChangZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ShiChangZhuangKuangv,
                    JiaoYiZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoYiZhuangKuangv,
                    ChaoXiang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ChaoXiang,
                    ChaoXiangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ChaoXiangv,
                    JiaoTongZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoTongZhuangKuang,
                    JiaoTongZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiaoTongZhuangKuangv,
                    HuanJingZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_HuanJingZhuangKuang,
                    HuanJingZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_HuanJingZhuangKuangv,
                    JiChuSheShiPeiTao: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiChuSheShiPeiTao,
                    JiChuSheShiPeiTaov: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JiChuSheShiPeiTaov,
                    GongGongFuWuSheShi: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_GongGongFuWuSheShi,
                    GongGongFuWuSheShiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_GongGongFuWuSheShiv,
                    JianZhuMianJi: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuMianJi,
                    JianZhuMianJiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuMianJiv,
                    CheWei: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_CheWei,
                    CheWeiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_CheWeiv,
                    WuYeGuanLi: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_WuYeGuanLi,
                    WuYeGuanLiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_WuYeGuanLiv,
                    XiaoQuHuanJing: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_XiaoQuHuanJing,
                    XiaoQuHuanJingv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_XiaoQuHuanJingv,
                    JianZhuLeiBie: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuLeiBie,
                    JianZhuLeiBiev: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuLeiBiev,
                    JianZhuJieGou: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuJieGou,
                    JianZhuJieGouv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianZhuJieGouv,
                    JianChengNianDai: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianChengNianDai,
                    JianChengNianDaiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_JianChengNianDaiv,
                    SheShiSheBei: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_SheShiSheBei,
                    SheShiSheBeiv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_SheShiSheBeiv,
                    HuXing: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_HuXing,
                    HuXingv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_HuXingv,
                    SuoZaiCengZongLouCeng: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_SuoZaiCengZongLouCeng,
                    SuoZaiCengZongLouCengv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_SuoZaiCengZongLouCengv,
                    ZhuangXiuZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ZhuangXiuZhuangKuang,
                    ZhuangXiuZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_ZhuangXiuZhuangKuangv,
                    QiTaYinSu: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_QiTaYinSu,
                    QiTaYinSuv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_QiTaYinSuv,
                    QuanYiZhuangKuang: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_QuanYiZhuangKuang,
                    QuanYiZhuangKuangv: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_QuanYiZhuangKuangv,
                    XiuZhengXiShu: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_XiuZhengXiShu,
                    BiZhunJiaZhi: $scope.KeBiShiLi2Data.n0_KeBiShiLi2_BiZhunJiaZhi
                }
            }, {
                tableName: 'n0_KeBiShiLi3',
                fields: {
                    XiangMuMingChen: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_XiangMuMingChen,
                    ZongJia: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ZongJia,
                    DanJia: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_DanJia,
                    JiaoYiRiQi: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoYiRiQi==''?'':$scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoYiRiQi+' 00:00:00',
                    JiaoYiRiQiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoYiRiQiv,
                    ShiChangZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ShiChangZhuangKuang,
                    JiaoYiZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoYiZhuangKuang,
                    ShiChangZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ShiChangZhuangKuangv,
                    JiaoYiZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoYiZhuangKuangv,
                    ChaoXiang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ChaoXiang,
                    ChaoXiangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ChaoXiangv,
                    JiaoTongZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoTongZhuangKuang,
                    JiaoTongZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiaoTongZhuangKuangv,
                    HuanJingZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_HuanJingZhuangKuang,
                    HuanJingZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_HuanJingZhuangKuangv,
                    JiChuSheShiPeiTao: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiChuSheShiPeiTao,
                    JiChuSheShiPeiTaov: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JiChuSheShiPeiTaov,
                    GongGongFuWuSheShi: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_GongGongFuWuSheShi,
                    GongGongFuWuSheShiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_GongGongFuWuSheShiv,
                    JianZhuMianJi: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuMianJi,
                    JianZhuMianJiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuMianJiv,
                    CheWei: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_CheWei,
                    CheWeiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_CheWeiv,
                    WuYeGuanLi: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_WuYeGuanLi,
                    WuYeGuanLiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_WuYeGuanLiv,
                    XiaoQuHuanJing: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_XiaoQuHuanJing,
                    XiaoQuHuanJingv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_XiaoQuHuanJingv,
                    JianZhuLeiBie: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuLeiBie,
                    JianZhuLeiBiev: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuLeiBiev,
                    JianZhuJieGou: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuJieGou,
                    JianZhuJieGouv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianZhuJieGouv,
                    JianChengNianDai: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianChengNianDai,
                    JianChengNianDaiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_JianChengNianDaiv,
                    SheShiSheBei: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_SheShiSheBei,
                    SheShiSheBeiv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_SheShiSheBeiv,
                    HuXing: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_HuXing,
                    HuXingv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_HuXingv,
                    SuoZaiCengZongLouCeng: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_SuoZaiCengZongLouCeng,
                    SuoZaiCengZongLouCengv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_SuoZaiCengZongLouCengv,
                    ZhuangXiuZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ZhuangXiuZhuangKuang,
                    ZhuangXiuZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_ZhuangXiuZhuangKuangv,
                    QiTaYinSu: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_QiTaYinSu,
                    QiTaYinSuv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_QiTaYinSuv,
                    QuanYiZhuangKuang: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_QuanYiZhuangKuang,
                    QuanYiZhuangKuangv: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_QuanYiZhuangKuangv,
                    XiuZhengXiShu: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_XiuZhengXiShu,
                    BiZhunJiaZhi: $scope.KeBiShiLi3Data.n0_KeBiShiLi3_BiZhunJiaZhi
                }
            },{
                tableName: 'n0_ShiChangJiaGeQueDing',
                fields: {
                    FangFa1: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_FangFa1,
                    FangFa2: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_FangFa2,
                    CeSuanJieGuo1: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_CeSuanJieGuo1,
                    CeSuanJieGuo2: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_CeSuanJieGuo2,
                    ChaEBiLi: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_ChaEBiLi,
                    ShiChangJiaZhi: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_ShiChangJiaZhi,
                    JianZhuMianJi: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_JianZhuMianJi,
                    QuanZhongHouDanJia: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_QuanZhongHouDanJia,
                    QuanZhong2: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_QuanZhong2,
                    QuanZhong1: $scope.ShiChangJiaGeQueDingData.n0_ShiChangJiaGeQueDing_QuanZhong1
                }
            }, {
                tableName: 'n0_DiYaJiaGeQueDing',
                fields: {
                    ChuRangJinKouChuHouDeDanJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_ChuRangJinKouChuHouDeDanJia,
                    ChuRangJinKouChuHouDeZongJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_ChuRangJinKouChuHouDeZongJia,
                    DiYaDanJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_DiYaDanJia,
                    DiYaZongJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_DiYaZongJia,
                    KouChuShuiFeiHouDeDanJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_KouChuShuiFeiHouDeDanJia,
                    KouChuShuiFeiHouDeZongJia: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_KouChuShuiFeiHouDeZongJia,
                    ShiChangJiaZhiShiFuKouChuChuRangJin: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_ShiChangJiaZhiShiFuKouChuChuRangJin,
                    ShangWeiBuJiaoDeChuRangJinJinE: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_ShangWeiBuJiaoDeChuRangJinJinE,
                    QiTaFaDingYouXianShouChangKuan: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_QiTaFaDingYouXianShouChangKuan,
                    TuoQianDeJianSheGongChengJiaKuan: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_TuoQianDeJianSheGongChengJiaKuan,
                    YiDiYaDanBaoDeZhaiQuanShuE: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_YiDiYaDanBaoDeZhaiQuanShuE,
                    CeSuanJingZhi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_CeSuanJingZhi,
                    ShiFuCeSuanJingZhi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_ShiFuCeSuanJingZhi,
                    JianZhuWuJiaZhi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_JianZhuWuJiaZhi,
                    JianZhuWuJiaZhiBaiFenBi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_JianZhuWuJiaZhiBaiFenBi,
                    TuDiJiaZhi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_TuDiJiaZhi,
                    TuDiJiaZhiBaiFenBi: $scope.DiYaJiaGeQueDingData.n0_DiYaJiaGeQueDing_TuDiJiaZhiBaiFenBi
                }
            }, {
                tableName: 'n0_FangFaLiYou',
                fields: {
                    QuanZhongQueDingLiYou: $scope.FangFaLiYouData.n0_FangFaLiYou_QuanZhongQueDingLiYou,
                    ChuRangJinShiFuKouChuDeLiYou: $scope.FangFaLiYouData.n0_FangFaLiYou_ChuRangJinShiFuKouChuDeLiYou,
                    BiJiaoFaFangFaLiYou1: $scope.FangFaLiYouData.n0_FangFaLiYou_BiJiaoFaFangFaLiYou1,
                    ShouYiFaFangFaLiYou2: $scope.FangFaLiYouData.n0_FangFaLiYou_ShouYiFaFangFaLiYou2,
                    ChengBenFaFangFaLiYou3: $scope.FangFaLiYouData.n0_FangFaLiYou_ChengBenFaFangFaLiYou3
                }
            }, {
                tableName: 'n0_GuJiaShiShengMing',
                fields: n0_GuJiaShiShengMing
            }, {
                tableName: 'n0_GuJiaShiJiaShe',
                fields: n0_GuJiaShiJiaShe
            }, {
                tableName: 'n0_XianZhiTiaoJian',
                fields: n0_XianZhiTiaoJian
            }, {
                tableName: 'n0_QiTaShuoMingShiXiang',
                fields: n0_QiTaShuoMingShiXiang
            }, {
                tableName: 'n0_ChengBenFa',
                fields: {
                    TouZiLiXi: $scope.ChengBenFaData.n0_ChengBenFa_TouZiLiXi,
                    FangDiChanDanJia: $scope.ChengBenFaData.n0_ChengBenFa_FangDiChanDanJia,
                    CanZhiLv: $scope.ChengBenFaData.n0_ChengBenFa_CanZhiLv,
                    JianZhuWuJingJiShouMing: $scope.ChengBenFaData.n0_ChengBenFa_JianZhuWuJingJiShouMing,
                    JianZhuWuZhongXinGouJianJiaGe: $scope.ChengBenFaData.n0_ChengBenFa_JianZhuWuZhongXinGouJianJiaGe,
                    JianZhuWuZheJiu: $scope.ChengBenFaData.n0_ChengBenFa_JianZhuWuZheJiu,
                    QiTaTeShuQingKuang: $scope.ChengBenFaData.n0_ChengBenFa_QiTaTeShuQingKuang,
                    ShuiXi: $scope.ChengBenFaData.n0_ChengBenFa_ShuiXi,
                    ZhongXiaoXueMingXiao: $scope.ChengBenFaData.n0_ChengBenFa_ZhongXiaoXueMingXiao,
                    GuiDaoJiaoTongZhanDianZhouBian500MiYiXia: $scope.ChengBenFaData.n0_ChengBenFa_GuiDaoJiaoTongZhanDianZhouBian500MiYiXia,
                    GuiDaoJiaoTongZhanDianZhouBian500MiYiShang: $scope.ChengBenFaData.n0_ChengBenFa_GuiDaoJiaoTongZhanDianZhouBian500MiYiShang,
                    GongYuan: $scope.ChengBenFaData.n0_ChengBenFa_GongYuan,
                    YinSuXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_YinSuXiuZhengXiShu,
                    RongJiLvXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_RongJiLvXiuZhengXiShu,
                    RongJiLvXiuZhengXiShuf: $scope.ChengBenFaData.n0_ChengBenFa_RongJiLvXiuZhengXiShuf,
                    FaDingChuRangZuiGaoNianXian: $scope.ChengBenFaData.n0_ChengBenFa_FaDingChuRangZuiGaoNianXian,
                    ShengYuDeTuDiShiYongNianXian: $scope.ChengBenFaData.n0_ChengBenFa_ShengYuDeTuDiShiYongNianXian,
                    YiNianQiDaiKuanLiLv: $scope.ChengBenFaData.n0_ChengBenFa_YiNianQiDaiKuanLiLv,
                    NianQiXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_NianQiXiuZhengXiShu,
                    QiRiXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_QiRiXiuZhengXiShu,
                    YongTuXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_YongTuXiuZhengXiShu,
                    DiXiaKongJianXiuZhengXiShu: $scope.ChengBenFaData.n0_ChengBenFa_DiXiaKongJianXiuZhengXiShu,
                    KaiFaChengDuChaYiXiuZhengZhi: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaChengDuChaYiXiuZhengZhi,
                    KaiFaChengDuChaYiZhi: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaChengDuChaYiZhi,
                    JiBieRongJiLv: $scope.ChengBenFaData.n0_ChengBenFa_JiBieRongJiLv,
                    ShiYongDeJiZhunDiJiaLouMianShuDiJia: $scope.ChengBenFaData.n0_ChengBenFa_ShiYongDeJiZhunDiJiaLouMianShuDiJia,
                    PianQuBianHao: $scope.ChengBenFaData.n0_ChengBenFa_PianQuBianHao,
                    JiZhunDiJiaJiBie: $scope.ChengBenFaData.n0_ChengBenFa_JiZhunDiJiaJiBie,
                    TuDiYongTu: $scope.ChengBenFaData.n0_ChengBenFa_TuDiYongTu,
                    TuDiQuDeShuiFei: $scope.ChengBenFaData.n0_ChengBenFa_TuDiQuDeShuiFei,
                    TuDiQuDeShuiFeif: $scope.ChengBenFaData.n0_ChengBenFa_TuDiQuDeShuiFeif,
                    TuDiShiYongQuanLouMianShuDiJia: $scope.ChengBenFaData.n0_ChengBenFa_TuDiShiYongQuanLouMianShuDiJia,
                    TuDiQuDeChengBen: $scope.ChengBenFaData.n0_ChengBenFa_TuDiQuDeChengBen,
                    GongGongPeiTaoSheShiJianSheFei: $scope.ChengBenFaData.n0_ChengBenFa_GongGongPeiTaoSheShiJianSheFei,
                    GongGongPeiTaoSheShiJianSheFeif: $scope.ChengBenFaData.n0_ChengBenFa_GongGongPeiTaoSheShiJianSheFeif,
                    GuanLiFeiYong: $scope.ChengBenFaData.n0_ChengBenFa_GuanLiFeiYong,
                    GuanLiFeiYongf: $scope.ChengBenFaData.n0_ChengBenFa_GuanLiFeiYongf,
                    DaiKuanLiLvf: $scope.ChengBenFaData.n0_ChengBenFa_DaiKuanLiLvf,
                    JianZhuAnZhuangGongChengFei: $scope.ChengBenFaData.n0_ChengBenFa_JianZhuAnZhuangGongChengFei,
                    JiChuSheShiJianSheFei: $scope.ChengBenFaData.n0_ChengBenFa_JiChuSheShiJianSheFei,
                    JiChuSheShiJianSheFeif: $scope.ChengBenFaData.n0_ChengBenFa_JiChuSheShiJianSheFeif,
                    KaiFaChengBen: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaChengBen,
                    KaiFaLiRun: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaLiRun,
                    KaiFaLiRunf: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaLiRunf,
                    KaiFaNianXianf: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaNianXianf,
                    KaiFaQiJianShuiFei: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaQiJianShuiFei,
                    KaiFaQiJianShuiFeif: $scope.ChengBenFaData.n0_ChengBenFa_KaiFaQiJianShuiFeif,
                    KanChaSheJi: $scope.ChengBenFaData.n0_ChengBenFa_KanChaSheJi,
                    KanChaSheJif: $scope.ChengBenFaData.n0_ChengBenFa_KanChaSheJif,
                    QianQiGongChengFei: $scope.ChengBenFaData.n0_ChengBenFa_QianQiGongChengFei,
                    QianQiGongChengFeif: $scope.ChengBenFaData.n0_ChengBenFa_QianQiGongChengFeif,
                    XiaoShouFeiYong: $scope.ChengBenFaData.n0_ChengBenFa_XiaoShouFeiYong,
                    XiaoShouFeiYongf: $scope.ChengBenFaData.n0_ChengBenFa_XiaoShouFeiYongf,
                    XiaoShouShuiFei: $scope.ChengBenFaData.n0_ChengBenFa_XiaoShouShuiFei,
                    XiaoShouShuiFeif: $scope.ChengBenFaData.n0_ChengBenFa_XiaoShouShuiFeif,
                    YinSuXiuZhengXiShuf: $scope.ChengBenFaData.n0_ChengBenFa_YinSuXiuZhengXiShuf,
                    YouXiaoNianLing: $scope.ChengBenFaData.n0_ChengBenFa_YouXiaoNianLing
                }
            }, {
                tableName: 'n0_ShouYiFa',
                fields: {
                    BaoChouLvf: $scope.ShouYiFaData.n0_ShouYiFa_BaoChouLvf,
                    BaoXianFei: $scope.ShouYiFaData.n0_ShouYiFa_BaoXianFei,
                    BaoXianFeif: $scope.ShouYiFaData.n0_ShouYiFa_BaoXianFeif,
                    ChengZhenTuDiShiYongShui: $scope.ShouYiFaData.n0_ShouYiFa_ChengZhenTuDiShiYongShui,
                    DiZengNianXian: $scope.ShouYiFaData.n0_ShouYiFa_DiZengNianXian,
                    FangChanShui: $scope.ShouYiFaData.n0_ShouYiFa_FangChanShui,
                    FangChanShuif: $scope.ShouYiFaData.n0_ShouYiFa_FangChanShuif,
                    FangDiChanJiaZhiCeSuanJieGuo: $scope.ShouYiFaData.n0_ShouYiFa_FangDiChanJiaZhiCeSuanJieGuo,
                    GeRenZongHeShuiFei: $scope.ShouYiFaData.n0_ShouYiFa_GeRenZongHeShuiFei,
                    GeRenZongHeShuiFeif: $scope.ShouYiFaData.n0_ShouYiFa_GeRenZongHeShuiFeif,
                    GuanLiFei: $scope.ShouYiFaData.n0_ShouYiFa_GuanLiFei,
                    GuanLiFeif: $scope.ShouYiFaData.n0_ShouYiFa_GuanLiFeif,
                    KeHuoShouYiNianXian: $scope.ShouYiFaData.n0_ShouYiFa_KeHuoShouYiNianXian,
                    KongZhiQi: $scope.ShouYiFaData.n0_ShouYiFa_KongZhiQi,
                    MeiPingMiTuDiNaShuiEf: $scope.ShouYiFaData.n0_ShouYiFa_MeiPingMiTuDiNaShuiEf,
                    NianFangDiChanJingShouYi: $scope.ShouYiFaData.n0_ShouYiFa_NianFangDiChanJingShouYi,
                    NianFangDiChanQianZaiMaoShouYi: $scope.ShouYiFaData.n0_ShouYiFa_NianFangDiChanQianZaiMaoShouYi,
                    NianFangDiChanYouXiaoMaoShouYi: $scope.ShouYiFaData.n0_ShouYiFa_NianFangDiChanYouXiaoMaoShouYi,
                    NianZongFeiYong: $scope.ShouYiFaData.n0_ShouYiFa_NianZongFeiYong,
                    QiTaShouRu: $scope.ShouYiFaData.n0_ShouYiFa_QiTaShouRu,
                    RiZuJin: $scope.ShouYiFaData.n0_ShouYiFa_RiZuJin,
                    RongJiLvf: $scope.ShouYiFaData.n0_ShouYiFa_RongJiLvf,
                    ShiFuZuJinDiZeng: $scope.ShouYiFaData.n0_ShouYiFa_ShiFuZuJinDiZeng,
                    WeiXiuFei: $scope.ShouYiFaData.n0_ShouYiFa_WeiXiuFei,
                    WeiXiuFeif: $scope.ShouYiFaData.n0_ShouYiFa_WeiXiuFeif,
                    YaJinBaoZhengJin: $scope.ShouYiFaData.n0_ShouYiFa_YaJinBaoZhengJin,
                    YaJinBaoZhengJinf: $scope.ShouYiFaData.n0_ShouYiFa_YaJinBaoZhengJinf,
                    YinHuaShui: $scope.ShouYiFaData.n0_ShouYiFa_YinHuaShui,
                    YinHuaShuif: $scope.ShouYiFaData.n0_ShouYiFa_YinHuaShuif,
                    YueZuJin: $scope.ShouYiFaData.n0_ShouYiFa_YueZuJin,
                    ZuJinDiZengBiLvf: $scope.ShouYiFaData.n0_ShouYiFa_ZuJinDiZengBiLvf
                }
            },{
                tableName: 'n0_XianChangKanCha',
                fields: {
                    WuLiJieGouQingKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_WuLiJieGouQingKuang,
                    WuLiJieGouShiFuBianHua: $scope.XianChangKanChaData.n0_XianChangKanCha_WuLiJieGouShiFuBianHua,
                    ShiFuRuHu: $scope.XianChangKanChaData.n0_XianChangKanCha_ShiFuRuHu,
                    QiTaYingXiangYinSu: $scope.XianChangKanChaData.n0_XianChangKanCha_QiTaYingXiangYinSu,
                    WanSunZhuangKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_WanSunZhuangKuang,
                    ShiYongJiWeiXiuZhuangKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_ShiYongJiWeiXiuZhuangKuang,
                    DianTiShuLiang: $scope.XianChangKanChaData.n0_XianChangKanCha_DianTiShuLiang,
                    XiaoFangSheShi: $scope.XianChangKanChaData.n0_XianChangKanCha_XiaoFangSheShi,
                    '24XiaoShiReShui': $scope.XianChangKanChaData.n0_XianChangKanCha_24XiaoShiReShui,
                    Chuang: $scope.XianChangKanChaData.n0_XianChangKanCha_Chuang,
                    Men: $scope.XianChangKanChaData.n0_XianChangKanCha_Men,
                    ChuFangQiTa: $scope.XianChangKanChaData.n0_XianChangKanCha_ChuFangQiTa,
                    ChuFangDiMian: $scope.XianChangKanChaData.n0_XianChangKanCha_ChuFangDiMian,
                    ChuFangQiangMian: $scope.XianChangKanChaData.n0_XianChangKanCha_ChuFangQiangMian,
                    ChuFangDingPeng: $scope.XianChangKanChaData.n0_XianChangKanCha_ChuFangDingPeng,
                    WeiShengJianQiTa: $scope.XianChangKanChaData.n0_XianChangKanCha_WeiShengJianQiTa,
                    WeiShengJianDiMian: $scope.XianChangKanChaData.n0_XianChangKanCha_WeiShengJianDiMian,
                    WeiShengJianQiangMian: $scope.XianChangKanChaData.n0_XianChangKanCha_WeiShengJianQiangMian,
                    WeiShengJianDingPeng: $scope.XianChangKanChaData.n0_XianChangKanCha_WeiShengJianDingPeng,
                    WoShiQiTa: $scope.XianChangKanChaData.n0_XianChangKanCha_WoShiQiTa,
                    WoShiDiMian: $scope.XianChangKanChaData.n0_XianChangKanCha_WoShiDiMian,
                    WoShiQiangMian: $scope.XianChangKanChaData.n0_XianChangKanCha_WoShiQiangMian,
                    WoShiDingPeng: $scope.XianChangKanChaData.n0_XianChangKanCha_WoShiDingPeng,
                    KeTingQiTa: $scope.XianChangKanChaData.n0_XianChangKanCha_KeTingQiTa,
                    KeTingDiMian: $scope.XianChangKanChaData.n0_XianChangKanCha_KeTingDiMian,
                    KeTingQiangMian: $scope.XianChangKanChaData.n0_XianChangKanCha_KeTingQiangMian,
                    KeTingDingPeng: $scope.XianChangKanChaData.n0_XianChangKanCha_KeTingDingPeng,
                    ZhuangXiuChengDu: $scope.XianChangKanChaData.n0_XianChangKanCha_ZhuangXiuChengDu,
                    KongJianBuJu: $scope.XianChangKanChaData.n0_XianChangKanCha_KongJianBuJu,
                    HuXing: $scope.XianChangKanChaData.n0_XianChangKanCha_HuXing,
                    JingGuanFang: $scope.XianChangKanChaData.n0_XianChangKanCha_JingGuanFang,
                    TongFengJiCaiGuangZhuangKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_TongFengJiCaiGuangZhuangKuang,
                    LiYongXianZhuang: $scope.XianChangKanChaData.n0_XianChangKanCha_LiYongXianZhuang,
                    ShiJiYongTu: $scope.XianChangKanChaData.n0_XianChangKanCha_ShiJiYongTu,
                    CengGao: $scope.XianChangKanChaData.n0_XianChangKanCha_CengGao,
                    ZongLouCeng: $scope.XianChangKanChaData.n0_XianChangKanCha_ZongLouCeng,
                    JianChengNianDai: $scope.XianChangKanChaData.n0_XianChangKanCha_JianChengNianDai,
                    GongGongBuFenZhuangXiu: $scope.XianChangKanChaData.n0_XianChangKanCha_GongGongBuFenZhuangXiu,
                    WaiLiMianZhuangShi: $scope.XianChangKanChaData.n0_XianChangKanCha_WaiLiMianZhuangShi,
                    JianZhuLeiBie: $scope.XianChangKanChaData.n0_XianChangKanCha_JianZhuLeiBie,
                    CheWei: $scope.XianChangKanChaData.n0_XianChangKanCha_CheWei,
                    MenJinXiTong: $scope.XianChangKanChaData.n0_XianChangKanCha_MenJinXiTong,
                    XiaoQuJianShiXiTong: $scope.XianChangKanChaData.n0_XianChangKanCha_XiaoQuJianShiXiTong,
                    '24XiaoShiBaoAn': $scope.XianChangKanChaData.n0_XianChangKanCha_24XiaoShiBaoAn,
                    WuYeGuanLiFei: $scope.XianChangKanChaData.n0_XianChangKanCha_WuYeGuanLiFei,
                    WuYeGuanLiShuiPing: $scope.XianChangKanChaData.n0_XianChangKanCha_WuYeGuanLiShuiPing,
                    RuZhuLv: $scope.XianChangKanChaData.n0_XianChangKanCha_RuZhuLv,
                    XiaoQuHuanJing: $scope.XianChangKanChaData.n0_XianChangKanCha_XiaoQuHuanJing,
                    XiaoQuMingChen: $scope.XianChangKanChaData.n0_XianChangKanCha_XiaoQuMingChen,
                    ChangDiPingZhengQingKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_ChangDiPingZhengQingKuang,
                    KaiFaChengDu: $scope.XianChangKanChaData.n0_XianChangKanCha_KaiFaChengDu,
                    QiTongYiPing: $scope.XianChangKanChaData.n0_XianChangKanCha_QiTongYiPing,
                    DiShi: $scope.XianChangKanChaData.n0_XianChangKanCha_DiShi,
                    DiXing: $scope.XianChangKanChaData.n0_XianChangKanCha_DiXing,
                    ZongDiXingZhuang: $scope.XianChangKanChaData.n0_XianChangKanCha_ZongDiXingZhuang,
                    BeiZhi: $scope.XianChangKanChaData.n0_XianChangKanCha_BeiZhi,
                    XiZhi: $scope.XianChangKanChaData.n0_XianChangKanCha_XiZhi,
                    NanZhi: $scope.XianChangKanChaData.n0_XianChangKanCha_NanZhi,
                    DongZhi: $scope.XianChangKanChaData.n0_XianChangKanCha_DongZhi,
                    WaiBuPeiTaoSheShiFenXi: $scope.XianChangKanChaData.n0_XianChangKanCha_WaiBuPeiTaoSheShiFenXi,
                    JiChuSheShi: $scope.XianChangKanChaData.n0_XianChangKanCha_JiChuSheShi,
                    QiTong: $scope.XianChangKanChaData.n0_XianChangKanCha_QiTong,
                    QiTaSheShi: $scope.XianChangKanChaData.n0_XianChangKanCha_QiTaSheShi,
                    XiuXianYuLeJianShenSheShi: $scope.XianChangKanChaData.n0_XianChangKanCha_XiuXianYuLeJianShenSheShi,
                    ZhongXiaoXue: $scope.XianChangKanChaData.n0_XianChangKanCha_ZhongXiaoXue,
                    YouErYuan: $scope.XianChangKanChaData.n0_XianChangKanCha_YouErYuan,
                    YiYuan: $scope.XianChangKanChaData.n0_XianChangKanCha_YiYuan,
                    ShangChang: $scope.XianChangKanChaData.n0_XianChangKanCha_ShangChang,
                    ChaoShi: $scope.XianChangKanChaData.n0_XianChangKanCha_ChaoShi,
                    YinXing: $scope.XianChangKanChaData.n0_XianChangKanCha_YinXing,
                    HuanJingZhuangKuangFenXi: $scope.XianChangKanChaData.n0_XianChangKanCha_HuanJingZhuangKuangFenXi,
                    JingGuan: $scope.XianChangKanChaData.n0_XianChangKanCha_JingGuan,
                    RenWenHuanJing: $scope.XianChangKanChaData.n0_XianChangKanCha_RenWenHuanJing,
                    ZiRanHuanJing: $scope.XianChangKanChaData.n0_XianChangKanCha_ZiRanHuanJing,
                    JiaoTongZhuangKuangFenXi: $scope.XianChangKanChaData.n0_XianChangKanCha_JiaoTongZhuangKuangFenXi,
                    TingCheFangBianChengDu: $scope.XianChangKanChaData.n0_XianChangKanCha_TingCheFangBianChengDu,
                    JiaoTongGuanZhiQingKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_JiaoTongGuanZhiQingKuang,
                    GuiDaoJiaoTongXianLu: $scope.XianChangKanChaData.n0_XianChangKanCha_GuiDaoJiaoTongXianLu,
                    GuiDaoJiaoTongZhanDian: $scope.XianChangKanChaData.n0_XianChangKanCha_GuiDaoJiaoTongZhanDian,
                    GongGongJiaoTongXianLu: $scope.XianChangKanChaData.n0_XianChangKanCha_GongGongJiaoTongXianLu,
                    GongGongJiaoTongZhanDian: $scope.XianChangKanChaData.n0_XianChangKanCha_GongGongJiaoTongZhanDian,
                    DaoLuLeiXing: $scope.XianChangKanChaData.n0_XianChangKanCha_DaoLuLeiXing,
                    QuYuZhuYaoDaoLu: $scope.XianChangKanChaData.n0_XianChangKanCha_QuYuZhuYaoDaoLu,
                    WeiZhiZhuangKuangFenXi: $scope.XianChangKanChaData.n0_XianChangKanCha_WeiZhiZhuangKuangFenXi,
                    YangTaiChaoXiang: $scope.XianChangKanChaData.n0_XianChangKanCha_YangTaiChaoXiang,
                    KeTingChaoXiang: $scope.XianChangKanChaData.n0_XianChangKanCha_KeTingChaoXiang,
                    CiWoChaoXiang: $scope.XianChangKanChaData.n0_XianChangKanCha_CiWoChaoXiang,
                    ZhuWoChaoXiang: $scope.XianChangKanChaData.n0_XianChangKanCha_ZhuWoChaoXiang,
                    ChaoXiang: $scope.XianChangKanChaData.n0_XianChangKanCha_ChaoXiang,
                    SuoZaiCeng: $scope.XianChangKanChaData.n0_XianChangKanCha_SuoZaiCeng,
                    LinJieZhuangKuang: $scope.XianChangKanChaData.n0_XianChangKanCha_LinJieZhuangKuang,
                    FangWeiFangXiangHeWeiZhi: $scope.XianChangKanChaData.n0_XianChangKanCha_FangWeiFangXiangHeWeiZhi,
                    FangWeiHuanXian: $scope.XianChangKanChaData.n0_XianChangKanCha_FangWeiHuanXian,
                    ShiDiKanChaQi: $scope.XianChangKanChaData.n0_XianChangKanCha_ShiDiKanChaQi,
                    YanFangJieShuShiJian: $scope.XianChangKanChaData.n0_XianChangKanCha_YanFangJieShuShiJian,
                    YanFangKaiShiShiJian: $scope.XianChangKanChaData.n0_XianChangKanCha_YanFangKaiShiShiJian
                }
            },{
                tableName: 'n0_JiChuXinXi',
                fields: {
        ...
        //console.log(n0_GuJiaShiShengMing);
